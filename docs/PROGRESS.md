...
- [ ] **M1** ReaderCore models: TabState, NavEntry, NavigationHistory, SessionSnapshot + versioned JSON codec, AppTheme
...
## Next step
M1 — then M2/M3/M4 may proceed in parallel (worktree agents); Package.swift already defines all targets so parallel work never edits it.
